 ...
 */
public record UserHoverElementEvent<E extends ElementLike<E>>(SunscreenUser<?> user, E element, Vec2i coords) implements UserEvent {

    @Override
    public Class<? extends Event> eventType() {
        return UserHoverElementEvent.class;
    }
