...
public final class Position extends RelativeMeasure.Vec2iRelativeMeasureGroup<Position> implements Property<Vec2i, Position> {
    ...
    private final Map<RelativeMeasure.Axis, Vec2iRelativeBuilder<Position>> axisMap = new LinkedHashMap<>();
    ...
    public Position(@NotNull RelativeMeasure.Vec2iRelativeMeasureGroup<?> measureGroup) {
        //axisMap.putAll((Map<? extends RelativeMeasure.Axis, ? extends Vec2iRelativeBuilder<Position>>) measureGroup.axisBuilderMap());
    }
