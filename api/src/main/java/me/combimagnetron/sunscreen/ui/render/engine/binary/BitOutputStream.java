package me.combimagnetron.sunscreen.ui.render.engine.binary;

import org.jetbrains.annotations.NotNull;

import java.io.*;

// Credits: https://stackoverflow.com/questions/13385603/does-anyone-have-a-good-java-bitbuffer & https://courses.cs.duke.edu/spring11/cps100e/assign/huff/code/BitOutputStream.html, I aint doing this myself brah
...
public class BitOutputStream extends OutputStream
{
     ...
     */
    public BitOutputStream(@NotNull OutputStream out){
        myOutput = out;
        initialize();
    }
    ...
    public BitOutputStream writeBits(int howManyBits, int value)
    {
